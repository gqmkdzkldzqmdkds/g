        ...
        fields = {
            ...
            2: {   # data
                ...
                9: {    # field9 - player details
                    1: "[C][B][FF0000] PAWAN ON TOP",  # Nickname
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]@pawan_gaming_yt.07 [00FF00]!!
"""
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF] PAWAN CODEX   
[FFD700]✨ Name on instagram : [FFFFFF] ❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> PAWAN CODEX ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "PAWAN CODEX", key, iv)
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]PAWAN CODEX
...
async def MaiiiinE():
    Uid , Pw = '4324804184','6509B3A6A0F220454CA47D2E32D6255249AF5603D645F242D85D0E30F467E6DD'
    ...
    os.system('clear')
    print("Initializing PAWAN CODEX Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('PAWAN CODEX', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 PAWAN CODEX BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using PAWAN CODEX")
    sys.exit(0)
